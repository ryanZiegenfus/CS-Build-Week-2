...
class CPU:
    ...
    def run(self):
        ...
        while running:
            ...
            if ir == '10100111':
                # print('CMP')
                # print(int(self.register[int(self.ram_read(self.pc + 1))], 2))
                # print(int(self.register[int(self.ram_read(self.pc + 2))], 2))
            ...
            # PRA
            if ir == '01001000':
                print(chr(int(self.register[int(self.ram_read(self.pc + 1), 2)], 2)))
                self.pc += 2
